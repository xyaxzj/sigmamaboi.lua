...
_G.autoBuyPatagotitan = false     -- 🦖 Patagotitan
_G.autoBuySpeed = false           -- ⚡ Speed (+1)
_G.autoBuyFrigorex = false        -- 👑 Frigorex
_G.autoBuyTricerabob = false      -- 🦏 Tricerabob
_G.autoBuyFarmPotion = false      -- 🧪 Farm Potion (I) (Khusus jam ganjil WIB max menit :10)
