-- ==========================================================
-- MOCTA TRADE AUTOMATOR V15.6 (SAFE EXECUTION EDITION)
-- ==========================================================
...
local success, errorMessage = pcall(function()
    ...
    if not networkFolder then error("Folder Network tidak ditemukan!") end
    ...
    -- Scanner Universal Auto-Accept (SAFE VERSION)
    ...
    local Window = Rayfield:CreateWindow({
        Name = "Mocta Trade V15.6", 
        LoadingTitle = "Safe Execution Mode...", 
                ...
                task.spawn(function() 
                    while AutoLoopEnabled do 
                        if #CurrentQueue == 0 then 
                            setLog("🏁 Antrean kosong. Auto Loop berhenti.") 
